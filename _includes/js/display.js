const display = ((options, search) => {
  ...
  const summary = (hits, blocks) =>
    options.get('search-advanced')
      ? `<p>Advanced search matched ${hits.length} of ${blocks.length} paragraphs or notes.</p>`
      : `<p>Simple search matched ${hits.length} of ${blocks.length} paragraphs or notes.</p>`;
